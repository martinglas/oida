 ...
 * </p>
 * <ul>
 *   <li>{@link oida.ontologyMgr.impl.GitRepoOntologyImpl#getRepoURL <em>Repo URL</em>}</li>
 *   <li>{@link oida.ontologyMgr.impl.GitRepoOntologyImpl#getGitUsername <em>Git Username</em>}</li>
 *   <li>{@link oida.ontologyMgr.impl.GitRepoOntologyImpl#getGitPassword <em>Git Password</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GitRepoOntologyImpl extends LocalOntologyImpl implements GitRepoOntology {
	...
	protected EClass eStaticClass() {
		return OntologyMgrPackage.Literals.GIT_REPO_ONTOLOGY;
	}
	...
	public void setRepoURL(String newRepoURL) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologyMgrPackage.GIT_REPO_ONTOLOGY__REPO_URL, oldRepoURL, repoURL));
	}
	...
	public void setGitUsername(String newGitUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologyMgrPackage.GIT_REPO_ONTOLOGY__GIT_USERNAME, oldGitUsername, gitUsername));
	}
	...
	public void setGitPassword(String newGitPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologyMgrPackage.GIT_REPO_ONTOLOGY__GIT_PASSWORD, oldGitPassword, gitPassword));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntologyMgrPackage.GIT_REPO_ONTOLOGY__REPO_URL:
				return getRepoURL();
			case OntologyMgrPackage.GIT_REPO_ONTOLOGY__GIT_USERNAME:
				return getGitUsername();
			case OntologyMgrPackage.GIT_REPO_ONTOLOGY__GIT_PASSWORD:
