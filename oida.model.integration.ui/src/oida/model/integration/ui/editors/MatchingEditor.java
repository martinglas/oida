...
public class MatchingEditor extends EditorPart {
	...
	public static final String ID = "net.bhl.cdt.model.integration.ui.editors.MappingEditor"; //$NON-NLS-1$
	...
	public void init(IEditorSite site, IEditorInput input) throws PartInitException {
		...
		recommendationProvider = new MatchingModel(rootEObject, "reference.owl", new ContainerContext(rootEObject));
	...
	protected DataBindingContext initDataBindings() {
		...
		IObservableList recommendationProviderMetaCandiatesOntResourcesObserveList = BeansObservables.observeList(
			Realm.getDefault(), recommendationProvider, "metaCandiatesOntResources");
