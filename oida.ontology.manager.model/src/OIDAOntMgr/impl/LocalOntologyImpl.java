 ...
 * </p>
 * <ul>
 *   <li>{@link OIDAOntMgr.impl.LocalOntologyImpl#getPath <em>Path</em>}</li>
 *   <li>{@link OIDAOntMgr.impl.LocalOntologyImpl#getFile <em>File</em>}</li>
 *   <li>{@link OIDAOntMgr.impl.LocalOntologyImpl#getMaintenanceFile <em>Maintenance File</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocalOntologyImpl extends MinimalEObjectImpl.Container implements LocalOntology {
	...
	protected EClass eStaticClass() {
		return OIDAOntMgrPackage.Literals.LOCAL_ONTOLOGY;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OIDAOntMgrPackage.LOCAL_ONTOLOGY__PATH, oldPath, path));
	}
	...
	public void setFile(String newFile) {
		...
		file = newFile;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OIDAOntMgrPackage.LOCAL_ONTOLOGY__FILE, oldFile, file));
	}
	...
	public void setMaintenanceFile(String newMaintenanceFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OIDAOntMgrPackage.LOCAL_ONTOLOGY__MAINTENANCE_FILE, oldMaintenanceFile, maintenanceFile));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OIDAOntMgrPackage.LOCAL_ONTOLOGY__PATH:
				return getPath();
			case OIDAOntMgrPackage.LOCAL_ONTOLOGY__FILE:
				return getFile();
			case OIDAOntMgrPackage.LOCAL_ONTOLOGY__MAINTENANCE_FILE:
