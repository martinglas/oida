 ...
 * @generated
 */
public class OIDAOntMgrSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OIDAOntMgrPackage.MANAGED_ONTOLOGY: {
