...
//		List<EObject> comprisedObjects = ModelProviderHelper.getComprisedEObjects(rootEObject);
//		List<String> names = new ArrayList<String>();
//		for (EObject comprisedObject : comprisedObjects) {
//			String name = getEObjectName(comprisedObject);
//			if (names.contains(name)) {
//				System.out.println("The " + getRenamerStrategy().getClass().getSimpleName() + " renaming strategy is ambiguous. At least two objects are named " + name);
//				return false;
//			}
//
//			else {
...
//			}
//		}
//		System.out.println("The " + getRenamerStrategy().getClass().getSimpleName() + " renaming strategy is unambiguous.");
//		return true;
//	}
//
//	public List<EObject> getAmbiguousEObjects() {
//		List<EObject> comprisedEObjects = ModelProviderHelper.getComprisedEObjects(rootEObject);
//
...
//	}
//
//	private void printContainers(EObject eObject, EObject rootEObject, Writer output) throws IOException {
...
//		return getRenamerStrategy().getEStructuralFeatureName(eStructuralFeature);
//	}
//
