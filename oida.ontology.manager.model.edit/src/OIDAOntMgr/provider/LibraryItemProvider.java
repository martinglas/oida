...
/**
 * This is the item provider adapter for a {@link OIDAOntMgr.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OIDAOntMgrPackage.Literals.LIBRARY__OWNER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OIDAOntMgrPackage.Literals.LIBRARY__CREATION_DATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOntologiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Library_ontologies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Library_ontologies_feature", "_UI_Library_type"),
				 OIDAOntMgrPackage.Literals.LIBRARY__ONTOLOGIES,
				 true,
				 false,
				 true,
				 null,
