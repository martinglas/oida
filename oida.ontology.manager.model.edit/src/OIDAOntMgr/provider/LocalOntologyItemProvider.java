...
/**
 * This is the item provider adapter for a {@link OIDAOntMgr.LocalOntology} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocalOntologyItemProvider 
	 ...
	 * @generated
	 */
	public LocalOntologyItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OIDAOntMgrPackage.Literals.LOCAL_ONTOLOGY__PATH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OIDAOntMgrPackage.Literals.LOCAL_ONTOLOGY__FILE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OIDAOntMgrPackage.Literals.LOCAL_ONTOLOGY__MAINTENANCE_FILE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns LocalOntology.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LocalOntology.class)) {
