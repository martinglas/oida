...
import oida.ontology.OntologyObjectSomeValuesFrom;
...
public class OntologyManagerUtils {
	...
	OntologyObjectSomeValuesFrom someValuesFrom = OntologyFactory.eINSTANCE.createOntologyObjectSomeValuesFrom();
