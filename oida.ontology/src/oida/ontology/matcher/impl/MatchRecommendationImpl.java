...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Match Recommendation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link oida.ontology.matcher.impl.MatchRecommendationImpl#getSource <em>Source</em>}</li>
 *   <li>{@link oida.ontology.matcher.impl.MatchRecommendationImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatchRecommendationImpl extends EObjectImpl implements MatchRecommendation {
	/**
	...
	public void setSource(OntResource newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MatcherPackage.MATCH_RECOMMENDATION__SOURCE, oldSource, source));
	}
	...
	public void setTarget(OntResource newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MatcherPackage.MATCH_RECOMMENDATION__TARGET, oldTarget, target));
	}
