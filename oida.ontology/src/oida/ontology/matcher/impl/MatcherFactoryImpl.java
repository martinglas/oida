...
public class MatcherFactoryImpl extends EFactoryImpl implements MatcherFactory {
	...
	public static MatcherFactory init() {
		try {
			MatcherFactory theMatcherFactory = (MatcherFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://bhl.net/cdt/ontology/matcher");
	...
	public EObject create(EClass eClass) {
		...
		case MatcherPackage.MATCH_RECOMMENDATION:
			return createMatchRecommendation();
	 ...
	 * @generated
	 */
	public OntResource createOntResourceFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertOntResourceToString(EDataType eDataType,
