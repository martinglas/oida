...
import net.bhl.oida.ontology.ui.OntologyLibraryView.OntologyLibraryViewInjectorProvider;
...
public class OntologyLibraryPart {
	...
	// ViewerContextMenuHelper contextMenuHelper =
	// injector.getInstance(ViewerContextMenuHelper.class);
	...
	// contextMenuHelper.addViewerContextMenu(treeViewer,
	// oidaService.getEditingDomain());
