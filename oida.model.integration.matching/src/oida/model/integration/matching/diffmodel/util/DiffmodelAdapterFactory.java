...
public class DiffmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected DiffmodelSwitch<Adapter> modelSwitch =
		new DiffmodelSwitch<Adapter>() {
			@Override
			public Adapter caseReferenceMatching(ReferenceMatching object) {
				return createReferenceMatchingAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link oida.model.integration.matching.diffmodel.ReferenceMatching <em>Reference Matching</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createReferenceMatchingAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link oida.model.integration.matching.diffmodel.DiffModel <em>Diff Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
