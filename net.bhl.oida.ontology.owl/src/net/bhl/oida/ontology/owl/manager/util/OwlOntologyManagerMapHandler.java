 ...
 ******************************************************************************/
package net.bhl.oida.ontology.owl.manager.util;
...
public final class OwlOntologyManagerMapHandler {
     ...
     *            should be found.
     * @param o
     *            The containing ontology. Only necessary, if the Thing class is
     *            to be received. If not, it can be null.
     * @return The OntologyClass object, or null, if it is not existing.
     */
	...
	// if
	// (p.getIRI().getIRIString().equals(owlTopObjectProperty.getIRI().getIRIString()))
     ...
     * 
     * @param c
     *            The OWLEntity object, for which the appropriate OntologyItem
     *            should be found.
